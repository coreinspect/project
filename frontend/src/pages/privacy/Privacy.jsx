         ...
         <div className="privacy-area">
            <div className="privacy-content">
               ...
               <p className="privacy-post">
                  Welcome to CodeDiv! This Privacy Policy outlines the ways in
                  which we collect, use, disclose, and protect your personal
                  information when you visit or interact with our website,
                  CodeDiv. Please read this Privacy Policy carefully to
                  understand how we handle your information.
               </p>
               <p className="privacy-title">1. Information We Collect:</p>
               <p className="privacy-post">
                  <span className="privacy-span">A. Personal Information:</span>
               ...
               <p className="privacy-post">
                  ...
                  limited to your IP address, browser type, device information,
                  and usage patterns when you visit our website.
               </p>
               <p className="privacy-title">2. How We Use Your Information:</p>
               ...
               <p className="privacy-post">
                  ...
                  providers who assist us in operating CodeDiv. These providers
                  are bound by confidentiality agreements and are prohibited
               ...
               <p className="privacy-post">
                  ...
                  information. You may also opt-out of certain communications or
                  services.
               </p>
               <p className="privacy-title">7. Children Privacy:</p>
               <p className="privacy-post">
                  CodeDiv is not directed at individuals under the age of 13. If
                  you believe that we have inadvertently collected personal
                  information from a child under 13, please contact us to remove
                  the information.
               </p>
               <p className="privacy-title">
